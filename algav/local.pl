...
encomenda(clA,[e(pB,1,100)]).
% encomenda(clB,[e(pA,1,110),e(pB,1,150),e(pC,1,300),e(pC,1,300)]).
encomenda(clC,[e(pA,1,110),e(pC,1,300)]).
encomenda(clD,[e(pB,1,150),e(pC,1,300)]).
encomenda(clE,[e(pA,1,110),e(pC,1,300)]).
encomenda(clF,[e(pC,1,300)]).
encomenda(clG,[e(pC,1,300)]).
encomenda(clH,[e(pC,1,300)]).
encomenda(clJ,[e(pC,1,300)]).
% ...
...
% permuta_tempo/3 faz uma permuta��o das opera��es atribu�das a uma maquina
% e calcula tempo de ocupa��o incluindo trocas de ferramentas
...
% calcula o menor tempo de atraso de uma lista de permuta��es de opera��es
...
% Calcula o atraso para uma dada permuta��o de opera��es
predXSetup([H|T],R):-
